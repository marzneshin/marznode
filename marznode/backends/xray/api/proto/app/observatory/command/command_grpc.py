...
import marznode.backends.xray.api.proto.app.observatory.config_pb2
import marznode.backends.xray.api.proto.app.observatory.command.command_pb2
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            '/xray.core.app.observatory.command.ObservatoryService/GetOutboundStatus': grpclib.const.Handler(
                ...
                marznode.backends.xray.api.proto.app.observatory.command.command_pb2.GetOutboundStatusRequest,
                marznode.backends.xray.api.proto.app.observatory.command.command_pb2.GetOutboundStatusResponse,
            ),
        }
