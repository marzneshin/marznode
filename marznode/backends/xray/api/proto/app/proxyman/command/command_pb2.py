...
from marznode.backends.xray.api.proto.common.protocol import user_pb2 as common_dot_protocol_dot_user__pb2
...
from marznode.backends.xray.api.proto.core import config_pb2 as core_dot_config__pb2
