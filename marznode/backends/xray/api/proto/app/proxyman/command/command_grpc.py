...
import marznode.backends.xray.api.proto.common.protocol.user_pb2
import marznode.backends.xray.api.proto.common.serial.typed_message_pb2
import marznode.backends.xray.api.proto.core.config_pb2
import marznode.backends.xray.api.proto.app.proxyman.command.command_pb2
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            '/xray.app.proxyman.command.HandlerService/AddInbound': grpclib.const.Handler(
                ...
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.AddInboundRequest,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.AddInboundResponse,
            ),
            '/xray.app.proxyman.command.HandlerService/RemoveInbound': grpclib.const.Handler(
                self.RemoveInbound,
                grpclib.const.Cardinality.UNARY_UNARY,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.RemoveInboundRequest,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.RemoveInboundResponse,
            ),
            '/xray.app.proxyman.command.HandlerService/AlterInbound': grpclib.const.Handler(
                self.AlterInbound,
                grpclib.const.Cardinality.UNARY_UNARY,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.AlterInboundRequest,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.AlterInboundResponse,
            ),
            '/xray.app.proxyman.command.HandlerService/AddOutbound': grpclib.const.Handler(
                self.AddOutbound,
                grpclib.const.Cardinality.UNARY_UNARY,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.AddOutboundRequest,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.AddOutboundResponse,
            ),
            '/xray.app.proxyman.command.HandlerService/RemoveOutbound': grpclib.const.Handler(
                self.RemoveOutbound,
                grpclib.const.Cardinality.UNARY_UNARY,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.RemoveOutboundRequest,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.RemoveOutboundResponse,
            ),
            '/xray.app.proxyman.command.HandlerService/AlterOutbound': grpclib.const.Handler(
                self.AlterOutbound,
                grpclib.const.Cardinality.UNARY_UNARY,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.AlterOutboundRequest,
                marznode.backends.xray.api.proto.app.proxyman.command.command_pb2.AlterOutboundResponse,
            ),
        }
